...
# ╔═╡ 404899a2-bd9f-11ee-0f6c-0bdde999fcb0
using Plots, DataFrames,CSV

# ╔═╡ cb2b6717-a612-4669-8280-6bdaf625a673
md"""
...
Se o número for par, corte-o pela metade; se
for ímpar, triplique-o e some 1.

$f(n)=\left\{\begin{array}{cc}
n/2, & \mathrm{se \: n \: é \: par} \\ 3n+1 , & \mathrm{se \: n \: é \: ímpar}
 \end{array}\right.$
...
function collatz(n)
	...
	return (n = n_inicial, interations = interations, even = even, odd = odd, even_p = even/(even+odd), odd_p = odd / (even+odd))
end


# ╔═╡ 68190ce7-eb46-4588-88c7-3db47b16f601
begin
	n_values = collect(1:10_000_000)
	results = [collatz(n) for n in n_values]
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "f0bc14e57444c58ba25ac0cb590b997eaa50fbc9"
